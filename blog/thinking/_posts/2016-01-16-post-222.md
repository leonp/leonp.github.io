...
I am actually a qualified teacher of English; in fact I was teaching when this site opened its doors. I reckon I've written around 111,000 words since then (a novel, no less).
...
All content will live on this site as I've implemented a simple taxonomy which you can use to find stuff you're interested in. That means it's goodbye to `theother.leonpaternoster.com`, `blog.leonpaternoster.com` and `nobulbs.com` and a return to how it was when this all began. Right.
